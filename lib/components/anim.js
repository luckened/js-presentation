...
function (_Component) {
  ...
  function Anim() {
    ...
    _defineProperty(_assertThisInitialized(_this), "disableAnimation", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateAnimation", function (nextAnimation) {
