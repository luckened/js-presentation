...
function (_Component) {
  ...
  function Manager(props) {
    ...
    _this._resetViewedIndexes = _this._resetViewedIndexes.bind(_assertThisInitialized(_this));
  ...
  _createClass(Manager, [{
    ...
    value: function _renderSlide() {
      ...
      var targetProps = {
        ...
        transitionDuration: !(0, _isNil["default"])(slide.props.transitionDuration) ? slide.props.transitionDuration : this.props.transitionDuration,
...
_defineProperty(Manager, "propTypes", {
  ...
  disableTouchControls: _propTypes["default"].bool,
